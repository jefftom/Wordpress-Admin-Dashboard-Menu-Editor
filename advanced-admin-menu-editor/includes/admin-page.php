        ...
        <div class="came-admin-header">
            <div class="came-config-selector">
                ...
                <div class="came-config-name-wrapper">
                    <input type="text" id="came-config-name" placeholder="<?php echo esc_attr__('Configuration Name', 'multiple-menus-admin-editor'); ?>" value="<?php echo esc_attr(isset($this->get_active_config()['name']) ? $this->get_active_config()['name'] : ''); ?>">
                </div>
            </div>
